...
- `output/top-leads-report.md` - full lead list + personalized outreach

## Project structure

- `src/config/profile.mjs` - your profile, services, links, and target-client filters
- `src/data/sampleLeads.mjs` - seed lead data (replace with real sourced leads)
...
2. Replace sample leads in `src/data/sampleLeads.mjs` with real prospects
