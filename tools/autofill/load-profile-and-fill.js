(() => {
  const profile = {
    ...
    portfolio: "https://www.behance.net/your-handle",
    ...
    currentCtcLpa: "10",
    expectedCtcLpa: "16",
    minimumAcceptableLpa: "12",
    willingToRelocate: "Yes",
    requiresSponsorship: "No",
    workAuthorization: "Indian Citizen",
    preferredWorkMode: "Hybrid",
    coverLetterShort:
      "I am excited to apply for this role and believe my experience in production pipelines, collaboration, and delivery quality can create immediate impact.",
  };
